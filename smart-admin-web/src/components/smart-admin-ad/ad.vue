<template>
  <div style="text-align:center">
    ...
    <img src="../../assets/images/HomeBulletframe.png" width="500px" height="300px"/>
    <p style="text-align:left;font-size:16px;">
   借鉴自 SmartAdmin由河南·洛阳 <a href="https://www.1024lab.net/" target="_blank">1024创新实验室</a>团队研发的一套互联网企业级的通用型中后台解决方案！使用SpringBoot和Vue，前后端分离。
    </p>
    <br/>
    <p style="text-align:left;font-size:16px">
